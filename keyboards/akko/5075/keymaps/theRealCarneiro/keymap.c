...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        VI_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,KC_NUHS,  KC_ENT,           KC_PGDN,
    ...
    [_VI] = LAYOUT(
        ...
        _______, _______, _______, KC_PGDN, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, _______, _______,          _______,
        VI_ADJ,  _______, _______, KC_DEL,  _______, SELWORD, WORDBAC, _______, _______, _______, _______, _______,          _______, _______, _______,
    ...
    [_FN] = LAYOUT(
        _______, _______, _______, _______, _______, KC_MPLY, KC_MSTP, KC_MNXT, KC_MPRV, _______, _______, _______, KC_F14,  KC_SLEEP,         KC_F15,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    [_RGB] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_M_P, _______, _______, _______,           _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAI,           RGB_SPI,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAD,           RGB_SPD,
...
combo_t key_combos[] = {
    ...
    COMBO(bootloader_combo, QK_CLEAR_EEPROM),
};
#endif
